...
import com.example.android.sunshine.app.MyWatchService;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int SYNC_INTERVAL = 60 * 1 / 5;
    ...
    /**
     * Create an intent to be processed by the service that syncs data with the wear app.
     */
    private void updateWearData() {
        Log.d(LOG_TAG, "in updateWearData");
        Intent intent = new Intent(getContext(), MyWatchService.class);
        intent.setAction(MyWatchService.ACTION_UPDATE_WEAR_DATA);
